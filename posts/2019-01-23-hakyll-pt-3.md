...
* _(wip) Pt. 4 – Copying Static Files For Your Build_
...
Thanks to [lobste.rs](https://lobste.rs) user
[abhin4v](https://lobste.rs/u/abhin4v), I was pointed to a pull request,
https://github.com/jaspervdj/hakyll/pull/652, that allows hakyll users to use
their own feed templates. Here is some example usage from the PR:
